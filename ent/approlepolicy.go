...
func (_m *AppRolePolicy) assignValues(columns []string, values []any) error {
...
func (_m *AppRolePolicy) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryRole queries the "role" edge of the AppRolePolicy entity.
func (_m *AppRolePolicy) QueryRole() *AppRoleQuery {
	return NewAppRolePolicyClient(_m.config).QueryRole(_m)
}

// QueryPolicy queries the "policy" edge of the AppRolePolicy entity.
func (_m *AppRolePolicy) QueryPolicy() *AppPolicyQuery {
	return NewAppRolePolicyClient(_m.config).QueryPolicy(_m)
}
...
func (_m *AppRolePolicy) Update() *AppRolePolicyUpdateOne {
	return NewAppRolePolicyClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the AppRolePolicy entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *AppRolePolicy) Unwrap() *AppRolePolicy {
...
func (_m *AppRolePolicy) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.AppPolicyID))
	builder.WriteString(", ")
