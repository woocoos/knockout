...
func (_m *OrgRoleUser) QueryOrgRole() *OrgRoleQuery {
	return NewOrgRoleUserClient(_m.config).QueryOrgRole(_m)
}

// QueryOrgUser queries the "org_user" edge of the OrgRoleUser entity.
func (_m *OrgRoleUser) QueryOrgUser() *OrgUserQuery {
	return NewOrgRoleUserClient(_m.config).QueryOrgUser(_m)
}

// QueryUser queries the "user" edge of the OrgRoleUser entity.
func (_m *OrgRoleUser) QueryUser() *UserQuery {
	return NewOrgRoleUserClient(_m.config).QueryUser(_m)
}

// QueryOrg queries the "org" edge of the OrgRoleUser entity.
func (_m *OrgRoleUser) QueryOrg() *OrgQuery {
	return NewOrgRoleUserClient(_m.config).QueryOrg(_m)
}
