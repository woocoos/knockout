...
func (_q *CountryQuery) QueryRegions() *RegionQuery {
...
func (_q *CountryQuery) WithRegions(opts ...func(*RegionQuery)) *CountryQuery {
	query := (&RegionClient{config: _q.config}).Query()
...
func (_q *CountryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Country, error) {
	...
	for name, query := range _q.withNamedRegions {
		if err := _q.loadRegions(ctx, query, nodes,
...
func (_q *CountryQuery) loadRegions(ctx context.Context, query *RegionQuery, nodes []*Country, init func(*Country), assign func(*Country, *Region)) error {
...
func (_q *CountryQuery) WithNamedRegions(name string, opts ...func(*RegionQuery)) *CountryQuery {
	query := (&RegionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedRegions == nil {
		_q.withNamedRegions = make(map[string]*RegionQuery)
	}
	_q.withNamedRegions[name] = query
	return _q
}
